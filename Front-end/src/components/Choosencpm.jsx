...
export default function Choosencpm() {
  return (
    <section className="w-3/4 flex mx-auto my-32 border-[1px] border-[#eee6e6] max-lga:w-[90%] max-lga:text-[16px] max-mda:flex-col ">
        ...
        <FaUser className='text-[#FFFFFF] text-[70px]'></FaUser>
         ...
         <Link to='/Registeruser' className='text-[#FFFFFF] bg-[#054DEC]  px-16 py-4 font-semibold text-[18px] cursor-pointer rounded-sm  max-sma:text-center max-sma:px-2'> Are you a user ?</Link>
        </Welcom>
        ...
        <FaUsers className='text-[#4B8DDF] text-[100px]'></FaUsers>
         ...
         <Link to='/Registerorg' className='text-[#458CE6] bg-[#FFFFFF] px-6 py-4 font-semibold text-[18px] cursor-pointer rounded-sm max-sma:text-center max-sma:px-2 '> Are you an organisation ? </Link>
        </Welcom>
    </section>
  )
}
