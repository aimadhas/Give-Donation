          ...
          <div className="lg:flex lg:items-start lg:gap-8">
            ...
            >
              <div className="col-span-2">
                <div>
                  <h2 className="text-2xl text-blue-800 font-bold text-gray-900">
                    Give help
                  </h2>

                  <p className="mt-4 text-gray-500">
                    Give is a community-powered fundraising platform. We believe that help is powerful, which is why we’re committed to making it safe and easy for anyone to give and get help.
                  </p>
                </div>
              </div>
